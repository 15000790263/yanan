...
import {
  ...
  getHGSBDetailByDataId,
  getGLQSBDetailByDataId,
  getGYGDSBDetailByDataId,
  getAQFJSBDetailByDataId,
} from '../../../../api/device';
      ...
      value = [
        {
          ...
          children: [
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '压力容器类别',
              value: main.value?.pressurevesselcategory,
            },
            {
              key: 'aaaaaaaa',
              label: '内径(mm)',
              value: main.value?.insidediameter,
            },
            {
              key: 'aaaaaaaa',
              label: '筒体厚度(mm)',
              value: main.value?.cylinderthickness,
            },
            {
              key: 'aaaaaaaa',
              label: '封头厚度(mm)',
              value: main.value?.headthickness,
            },
            {
              key: 'aaaaaaaa',
              label: '长/高度(mm)',
              value: main.value?.highorlong,
            },
            {
              key: 'aaaaaaaa',
              label: '容积(m³)',
              value: main.value?.volume,
            },
            {
              key: 'aaaaaaaa',
              label: '筒体材质',
              value: sysStore.getDictValue('well_material', main.value?.cylinder),
            },
            {
              key: 'aaaaaaaa',
              label: '封头材质',
              value: sysStore.getDictValue('well_material', main.value?.head),
            },
            {
              key: 'aaaaaaaa',
              label: '净重(KG)',
              value: main.value?.netweight,
            },
            {
              key: 'aaaaaaaa',
              label: '设计单位',
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '制造许可证等级',
              value: main.value?.manufacturinglicenselevel,
            },
            {
              key: 'aaaaaaaa',
              label: '制造许可证编号',
              value: main.value?.manufacturinglicensenumber,
            },
            {
              key: 'aaaaaaaa',
              label: '产品标准',
              value: main.value?.productstandards,
            },
            {
              key: 'aaaaaaaa',
              label: '制造单位',
              value: main.value?.manufacturingunit,
            },
            {
              key: 'aaaaaaaa',
              label: '制造年月',
              value: main.value?.manufacturedate,
            },
            {
              key: 'aaaaaaaa',
              label: '投用年月',
              value: main.value?.usedate,
            },
            {
              key: 'aaaaaaaa',
              label: '保温或内衬',
              value: main.value?.insulationorlining,
            },
            {
              key: 'aaaaaaaa',
              label: '设计压力(MPa)',
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '耐压试验压力(MPa)',
              value: main.value?.proofpressure,
            },
            {
              key: 'aaaaaaaa',
              label: '设计温度(℃)',
              value: main.value?.designtemperature,
            },
            {
              key: 'aaaaaaaa',
              label: '容器图号',
              value: main.value?.containerdrawingnumber,
            },
            {
              key: 'aaaaaaaa',
              label: '注册代码',
              value: main.value?.registrationcode,
            },
            {
              key: 'aaaaaaaa',
              label: '使用登记证编号',
              value: main.value?.registrationnumber,
            },
            {
              key: 'aaaaaaaa',
              label: '使用年限(年)',
              value: main.value?.life,
            },
            {
              key: 'aaaaaaaa',
              label: '设备状态',
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '安装部位',
              value: main.value?.location,
            },
            {
              key: 'aaaaaaaa',
              label: '资产属性',
              value: sysStore.getDictValue('asset_attributes', main.value?.assetattributes),
            },
            {
              key: 'aaaaaaaa',
              label: '定检周期',
      ...
      value = [
        {
          ...
          children: [
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '管道名称',
              value: main.value?.pipename,
            },
            {
              key: 'aaaaaaaa',
              label: '管道编号',
              value: main.value?.pipenumber,
            },
            {
              key: 'aaaaaaaa',
              label: '管道级别',
              value: main.value?.pipelevel,
            },
            {
              key: 'aaaaaaaa',
              label: '设计单位',
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '安装单位',
              value: main.value?.installationunit,
            },
            {
              key: 'aaaaaaaa',
              label: '安装竣工日期',
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '公称直径（mm）',
              value: main.value?.nominaldiameter,
            },
            {
              key: 'aaaaaaaa',
              label: '公称壁厚(mm)',
              value: main.value?.nominalwallthickness,
            },
            {
              key: 'aaaaaaaa',
              label: '管道长度(mm)',
              value: main.value?.pipelength,
            },
            {
              key: 'aaaaaaaa',
              label: '设计压力(MPa)',
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '设计工作介质',
              value: sysStore.getDictValue('well_material', main.value?.designmedium),
            },
            {
              key: 'aaaaaaaa',
              label: '工作压力(MPa)',
              value: main.value?.workingpressure,
            },
            {
              key: 'aaaaaaaa',
              label: '工作温度(℃)',
              value: main.value?.workingtemperature,
            },
            {
              key: 'aaaaaaaa',
              label: '工作介质',
              value: sysStore.getDictValue('well_material', main.value?.workingmedium),
            },
            {
              key: 'aaaaaaaa',
              label: '设备状态',
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '安全管理部门',
              value: main.value?.safety,
            },
            {
              key: 'aaaaaaaa',
              label: '安全管理员',
              value: main.value?.securityadmin,
            },
            {
              key: 'aaaaaaaa',
              label: '使用单位',
              value: main.value?.useunit,
            },
            {
              key: 'aaaaaaaa',
              label: '使用单位地址',
              value: main.value?.useunitaddress,
            },
            {
              key: 'aaaaaaaa',
              label: '负责人',
      ...
      value = [
        {
          ...
          children: [
            ...
            },
            {
              key: 'aaaaaaaa',
              label: '使用寿命',
              value: main.value?.uselife,
            },
            {
              key: 'aaaaaaaa',
              label: '用途',
              value: main.value?.touse,
            },
            {
              key: 'aaaaaaaa',
              label: '备注',
...
async function getDetail() {
  ...
  switch (typeValue) {
    case '7010':
      // 汇管
      res = await getHGSBDetailByDataId(dataId);
      console.log(res);
      break;

    case '6016':
      // 过滤器
      res = await getGLQSBDetailByDataId(dataId);
      break;

    case '7012':
      // 过滤器
      res = await getGYGDSBDetailByDataId(dataId);
      break;

    default:
      // 过滤器
      res = await getAQFJSBDetailByDataId(dataId);
      break;
  }
